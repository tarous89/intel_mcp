...
| [S19](#s19--deploy-the-integrated-candidate-for-the-user-led-pilot) | Deploy the integrated candidate for the user-led pilot | IN_PROGRESS | Restricted owner pilot is live: Engine `e606612`, App runtime `035c242`, pilot deploy `dep-dan5ud3m8hqs73a5u0u0`; exact-account allowlist active, new work enabled for that account only, baseline memory ~171 MiB. Awaiting the user's first real report. |
