    ...
    <section id="tools">
      <div class="shell">
        ...
        <div class="workflow">
          ...
          <article class="tool-card"><div class="tool-top"><code>classify_trials</code><span class="tool-order">03</span></div><h3>Classify eligibility</h3><p>Sends each complete contact-redacted profile, including results and document inventory, to Terra, then returns only eligible, ineligible, and uncertain ID buckets.</p><span class="limit">Up to 25 trials per call</span></article>
          <article class="tool-card"><div class="tool-top"><code>get_profiles</code><span class="tool-order">04</span></div><h3>Read complete profiles</h3><p>Returns complete approved 10.0.0 profiles, including results and the six document-category arrays.</p><span class="limit">Up to 10 trials per call</span></article>
        ...
        <div class="callout"><strong>Document filenames live in Trial Profiles.</strong> Call <code>get_profiles</code> first and copy the exact name from <code>filtering_variables.available_extracted_documents</code> before calling <code>get_documents</code>. Empty categories are returned as empty arrays.</div>
      </div>
    </section>
